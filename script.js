...
function search(arg){
  ...
  for (i; i < filename_list.length; i++) {
    if (found == false && filename_list[i][0]==arg) {
      ...
      var used_by = filename_list[i][2] ;
      found == true;
    }
    if (found==true) {
      console.log("extension name found in database!");
      // break;
    }
  }
...
var filename_list = [
  ...
  ['ANIM','Trainz Animation specification file, for example a steam locomotives connecting rod movements, or water movement on a river or lake motion. (Obsolescent)','Trainz/Auran JET files'],
  ...
  ['APE','Monkey Audio (Lossless)','audio media players'],
  ...
  ['DBF','Database file','dBASE III/IV - Visual FoxPro - dBFast - DataBoss - DBVista - CA-Clipper - Visual Objects - Alaska Xbase++ - Advantage Database Server'],
  ...
  ['DESKLINK','Windows Explorer Desktop Control (commonly "Desktop (create shortcut).DESKLINK", 0 bytes). Uses aspecial hidden file extension (NeverShowExt flag inside the Registry], overriding the Windows Explorer option of showing/hiding file extensions.',''],
  ...
  ['DVDPROJ','iDVD project file','iDVD (Apple iLife08)'],
  ...
  ['EKA','Internal data files','Borlands Eureka'],
  ...
  ['IGC','Flight tracks downloaded from GPS devices in the International Gliding Commissions prescribed format',''],
  ...
  ['ILK','Outline of programs format','Microsoft ILink incremental linker'],
  ...
  ['ISH','Archive','ISH'],
  ['ISMA','Output Video file','Islam Abusaa Software'],
  ...
  ['KB','K-Brief in XML format','TCCs Set-Based Thinking™ Tools'],
  ['KBA','K-Brief Attachment','TCCs Set-Based Thinking™ Tools'],
  ['KBASIC','Source','KBasic'],
  ['KBD','Keyboard mapping','LocoScript - Signature - Procomm Plus'],
  ['KBM','Keyboard mapping','Reflection 4.0'],
  ['KBS','K-Brief in Encrypted format','TCCs Set-Based Thinking™ Tools'],
  ['KBZ','K-Brief in Compressed format','TCCs Set-Based Thinking™ Tools'],
  ...
  ['KMC','KatzReviews MegaCrammer',''],
  ['KML','Kedit Macro Library Keyhole Markup Language','Kedit Google Earth'],
  ['KMY','data','KMyMoney'],
  ...
  ['MDL','Nintendo GameCube Luigis Mansion Model','Nintendo'],
  ...
  ['NSA','media','soft Streaming Audio'],
  ...
  ['NSV','media','soft Streaming Video'],
  ...
  ['OCX','New Custom Controls format in VB 4.0','Visual Basic'],
  ...
  ['OTL','Ventura Publishers Type Foundry Outline Editor format',''],
  ...
  ['PCJ','Multimedia authoring tool graphics file','IBMs Linkaway-Live'],
  ...
  ['PDF','Adobes Portable Document Format','Adobe Acrobat Reader'],
  ...
  ['PDM','PowerDesigners physical data model (relational model) file format','PowerDesigner'],
  ...
  ['PIT','Partition Information Table for Samsungs smartphone with Android','Odin3'],
  ...
  ['PLIST','Mac OS Property List, also used on iOS, NeXTSTEP, and GNUstep','Apples Property List Editor'],
  ...
  ['POLY','Data','Patrick Flynns Poly Format - 3D object'],
  ...
  ['PRE','Settings','Programmers WorkBench, Microsoft C/C++'],
  ...
  ['PTPED','PedFast Technologies Pedigree Database[11]','The Breeders Standard, iPed, The Catterys Standard, Equestrians Standard'],
  ...
  ['QB','Tony Hawks Pro Skater series scripting files',''],
  ...
  ['QRP','Database report file','QuickReport[12]'],
  ...
  ['SDA','Fidonets Software Distribution Network file archive description',''],
  ...
  ['SHG','Segmented Hyper Graphics','Microsofts shed.exe, JGsofts Hotspot Builder, EC Softwares Help and Manual'],
  ['SHK','Apple II archive','SHRINKIT'],
  ['SHM','Shell macro','WordPerfect Library'],
  ['SHP','Shape file and sdiv id="PYI"> PYIource file for text fonts ESRI shapefile','AutoCAD ArcGIS'],
  ['SHR','see SHAR',''],
  ...
  ['SHX','Shape entities ESRI shapefile','AutoCAD ArcGIS'],
  ...
  ['SMN','Font (ParaGraphs WorkScript format)',''],
  ...
  ['TFC','Catalogue file','Tobis Floppy Cataloguer'],
  ...
  ['THE','Windows95 Desktop Theme','Microsoft Plus'],
  ...
  ['TRIA','Data','Greg Hoods ASCII Triangle'],
  ['TRIB','Data','Greg Hoods Binary Triangle'],
  ...
  ['UI','Qt Designers UI File','Trolltech Qt Designer'],
  ...
  ['VOC','Sound format (Creative Labs Sound File)','PlayVoc'],
  ...
  ['WAD','Wheres All the Data?','Doom - Doom2'],
